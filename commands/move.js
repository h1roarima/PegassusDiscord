...
module.exports = {
  name: "move",
  description: "Mueve una canción a una posición específica",
  usage: "",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (trackNum < 1 || trackNum > player.queue.length - 1) {
      return client.sendTime(message.channel, "❌ | **Número de canción erróneo.**");
    }
  ...
  SlashCommand: {
    options: [
      ...
      },
      {
        ...
        type: 4,
        required: true,
        description: "Mueve la canción seleccionada a la posición especificada.",
      },
    ],
    /**
     *
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      if (!args[0].value || !args[1].value)
        return client.sendTime(interaction, "❌ | **Número de canción erróneo.**");
