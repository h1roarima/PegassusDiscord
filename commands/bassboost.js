...
module.exports = {
  name: "bassboost",
  description: "Habilita el refuerzo de graves",
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!args[0])
      return client.sendTime(
        message.channel,
        "**Por favor selecciona un nivel de BassBoost. \nNiveles Disponibles:** `none`, `low`, `medium`, `high`"
    ...
    return client.sendTime(
      message.channel,
      `✅ | **Nivel de BassBoost ajustado a** \`${level}\``
    );
  },
  SlashCommand: {
    options: [
      {
        name: "level",
        description: `Por favor selecciona un nivel de BassBoost. Niveles Disponibles: low, medium, high, or none`,
        value: "[level]",
        type: 3,
        required: true,
      },
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      return client.sendTime(
        interaction,
        `✅ | **Ajusta en nivel de BassBoost a** \`${level}\``
      );
    },
  },
};
