...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!player.playing)
      return client.sendTime(
        message.channel,
        "❌ | **ada reproduciéndose en este momento...**"
      );
    ...
    client.sendTime(message.channel, "✅ | **Mira tus DMs!**");
  },
  SlashCommand: {
    /**
     *
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      try {
        ...
        return client.sendTime(interaction, "**:x: Tus DMs están deshabilitados**");
      }

      client.sendTime(interaction, "✅ | **Mira tus DMs!**");
    },
  },
};
